...
function About() {
  ...
  const [s_team, sets_team] = useState([
    {
      team_src:
        "https://quiety-wp.themetags.com/wp-content/uploads/2021/10/team-1.jpeg",
      team_name: "Penny Tool",
      team_type: "Analyst",
    },
    {
      team_src:
        "https://quiety-wp.themetags.com/wp-content/uploads/2021/10/team-2.jpeg",
      team_name: "Penny Tool",
      team_type: "Analyst",
    },
    {
      team_src:
        "https://quiety-wp.themetags.com/wp-content/uploads/2021/10/team-3.jpeg",
      team_name: "Penny Tool",
      team_type: "Analyst",
    },
    {
      team_src:
        "https://quiety-wp.themetags.com/wp-content/uploads/2021/10/team-4.jpeg",
      team_name: "John Sullivan",
      team_type: "Product Designer",
    },
    {
      team_src:
        "https://quiety-wp.themetags.com/wp-content/uploads/2021/10/team-5.jpeg",
      team_name: "Lance Bogrol",
      team_type: "Front End Developer",
    },
    {
      team_src:
        "https://quiety-wp.themetags.com/wp-content/uploads/2021/10/team-6.jpeg",
      team_name: "Ravi Leigh",
      team_type: "Manager",
    },
    {
      team_src:
        "https://quiety-wp.themetags.com/wp-content/uploads/2021/10/team-7.jpeg",
      team_name: "Joss Sticks",
      team_type: "Sumo founder",
    },
    {
      team_src:
        "https://quiety-wp.themetags.com/wp-content/uploads/2021/10/team-8.jpeg",
      team_name: "Joanne Bell",
      team_type: "CEO",
    },
  ]);
  return (
      ...
      <section className="fourthsec">
        ...
        <div className="container">
          <div className="row pt-5 ">
            {s_team.map((s_team_data) => {
              return (
                <Team
                  src={s_team_data.team_src}
                  name={s_team_data.team_name}
                  type={s_team_data.team_type}
                />
              );
            })}
          </div>
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-3">
                <h5 className=" paratextp">Primary Pages</h5>
                <div className="mt-4">
              ...
              <div className="col-md-2">
                <h5 className=" paratextp">Pages</h5>
                <div className="mt-4">
                  <ul className="pageslst">
                    <li className="pl-3">
                      <a href="">home</a>
              ...
              <div className="col-md-2">
                <h5 className=" paratextp">Templates</h5>
                <div className="mt-4">
                  <ul className="pageslst">
                    <li className="">
                      <a href="">home</a>
