      ...
      <section className="container-fluid bannerbackground ">
        <div className="container" data-aos="fade-up" data-aos-duration="1000">
          ...
          <ul className="row all-author-card">
            <div className="col-lg-3 col-md-6 col-sm-6 col-6  pl-0 pb-3">
              <li className="  single-author-card ">
                <a>
                  <div className="author-image">
                    <img
                      src="https://quiety-wp.themetags.com/wp-content/plugins/quiety-core/elementor/assets/images/author1.jpg"
                      alt="Joe Richard"
                    />
                  </div>

                  <div className="author-info">
                    <h3 className="tab-name">Joe Richard</h3>

                    <span className="tab-designation">Visual Designer</span>
                  </div>
                </a>
              </li>
            </div>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6 col-6 pl-0 pb-3">
              <li className="  single-author-card">
                <a>
                  <div className="author-image">
                    <img
                      src="https://quiety-wp.themetags.com/wp-content/uploads/2021/10/3.jpeg"
                      alt="Joe Richard"
                    />
                  </div>
